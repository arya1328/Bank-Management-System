...
class BankingApp(QMainWindow):
    ...
    def init_ui(self):
        ...
        # Group input fields in a QGroupBox
        ...
        # Group buttons in QGroupBox
        button_group1 = QGroupBox("Account Operations")
        button_group1.setLayout(button_layout1)

        button_group2 = QGroupBox("Account Information")
        button_group2.setLayout(button_layout2)

        button_group3 = QGroupBox("System Operations")
        button_group3.setLayout(button_layout3)

        # Add layouts to main layout
        self.layout.addWidget(input_group)
        self.layout.addWidget(button_group1)
        self.layout.addWidget(button_group2)
        self.layout.addWidget(button_group3)
